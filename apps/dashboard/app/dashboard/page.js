    ...
    <>
      <div className="flex flex-col gap-10 max-w-5xl mx-auto w-full pt-8 px-4 md:px-0">
        ...
        >
          ...
          {/* Table Body */}
          <div className="flex flex-col divide-y divide-surface-border min-h-50">
            {loading ? (
              ...
              projects.map((project) => (
                ...
                >
                  ...
                  <div className="col-span-5 flex flex-col gap-1">
                    <span className="text-sm font-medium text-text-primary group-hover:text-accent-cyan transition-colors">{project.name}</span>
                  ...
                  <div className="col-span-3 flex items-center">
                    {project.status === 'ready' || project.status === 'active' ? (
                      ...
                      <div className="flex items-center gap-2 px-2.5 py-1 rounded-full bg-accent-cyan/10 border border-accent-cyan/20 text-accent-cyan text-[11px] font-mono uppercase tracking-widest shadow-[0_0_10px_rgba(6,182,212,0.15)] relative overflow-hidden">
              ...
              <form onSubmit={handleCreateProject} className="flex flex-col">
                ...
                <div className="p-6 pt-0 flex flex-col gap-4">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      className="w-full bg-bg-elevated text-text-primary border border-surface-border-strong rounded-xl px-4 py-3 outline-none focus:border-accent-cyan focus:ring-1 focus:ring-accent-cyan/50 transition-all text-sm placeholder:text-text-tertiary"
                    />
                  </div>
                </div>
                ...
                <div className="p-4 bg-bg-elevated/50 border-t border-surface-border flex justify-end gap-3">
                  ...
                  <button
                    ...
                    className="bg-accent-cyan hover:bg-accent-cyan-hover text-black font-semibold rounded-lg px-5 py-2 text-sm transition-all active:scale-[0.97] shadow-[0_0_15px_rgba(6,182,212,0.3)] flex items-center justify-center min-w-30 disabled:opacity-50 disabled:active:scale-100 cursor-pointer"
                  >
                    {isCreating ? (
